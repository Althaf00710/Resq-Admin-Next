...
export type FirstAidCardProps = {
  ...
  className?: string;
  /** 'stack' = show subcategory pill; 'grid' = show Edit/Delete buttons */
  variant?: "stack" | "grid";
  onEdit?: (detail: FirstAidDetail) => void;
  onDelete?: (detail: FirstAidDetail) => void;
};
      ...
      <div className="relative w-full pt-[56%] bg-gray-100">
        ...
        {variant === "stack" ? (
          ...
          <div className="absolute right-3 top-3 flex items-center gap-2">
            <EditButton label="" onClick={() => onEdit?.(detail)} />
            <DeleteButton label="" onClick={() => onDelete?.(detail)} />
          </div>
        )}
      </div>
