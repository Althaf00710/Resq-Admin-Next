    ...
    return (
      <div className="relative">
        <input
          ...
          ref={ref}
          className={`
            peer p-4 block w-full border-gray-200 rounded-full sm:text-sm placeholder:text-transparent
        ...
        <label
          htmlFor={id}
          className={`
            absolute top-0 start-0 p-4 h-full sm:text-sm truncate pointer-events-none transition ease-in-out duration-100
